...
public interface RealizationNatureRepository extends JpaRepository<ProcurementNature, Long> {
    ...
    Page<ProcurementNature> findNaturesRequiringEnvironmentalAssessment(Pageable pageable);
    ...
    Page<ProcurementNature> findNaturesRequiringTechnicalExpertise(Pageable pageable);
