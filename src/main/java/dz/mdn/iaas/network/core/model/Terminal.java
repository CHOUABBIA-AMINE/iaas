...
@Table(name="T_03_03_04", uniqueConstraints = { @UniqueConstraint(name="T_03_03_04_UK_01", columnNames={"F_02"}) })
public class Terminal extends Facility {

    @ManyToOne
    @JoinColumn(name="F_13", foreignKey=@ForeignKey(name="T_03_03_04_FK_01"), nullable=false)
    private TerminalType terminalType;

    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(
        name = "R_T030304_T030307",
        joinColumns = @JoinColumn(name = "F_01", foreignKey=@ForeignKey(name="R_T030304_T030307_FK_01")),
        inverseJoinColumns = @JoinColumn(name = "F_02", foreignKey=@ForeignKey(name="R_T030304_T030307_FK_02")),
